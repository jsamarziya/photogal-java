...
/**
 * A subclass of WebService that provides access to a PhotogalDao.
 */
public abstract class PhotogalDaoAwareWebService extends WebService implements InitializingBean {
    private PhotogalDao photogalDao;

    /**
     * Returns the PhotogalDao used by this service.
     * 
    ...
    /**
     * Sets the PhotogalDao used by this service.
     * 
