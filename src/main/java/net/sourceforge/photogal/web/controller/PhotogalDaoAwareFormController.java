...
/**
 * A subclass of AbstractFormController that provides access to a PhotogalDao.
 */
public abstract class PhotogalDaoAwareFormController extends AbstractFormController implements
        InitializingBean {
