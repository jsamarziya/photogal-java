...
public class FetchImagesByDatePosted extends AbstractFetchImagesByDateStrategy {
    ...
    private Date getStartDate(ShowImagesByDateForm form) {
        ...
        cal.set(Calendar.MONTH, form.getMonth() - 1);
    ...
    @Override
    public List<ImageDescriptor> getImages(final ShowImagesByDateForm form) {
