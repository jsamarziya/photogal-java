...
/**
 * A subclass of AbstractController that provides access to a PhotogalDao.
 */
public abstract class PhotogalDaoAwareController extends AbstractController implements
        InitializingBean {
