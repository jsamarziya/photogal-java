...
<title><fmt:message key="head.title">
	<fmt:param value="Delete gallery" />
</fmt:message></title>
...
<div style="margin-top: 50px">Are you sure you want to delete
gallery <b><c:out value="${gallery.name}" /></b>?</div>
<div style="margin-top: 25px">
<form name="theForm" method="post"
	action="<c:url value="/edit/deleteGallery.do"/>"><input
	type="hidden" name="action" value="delete" /> <input type="hidden"
	name="galleryId" value="${gallery.id}" />
